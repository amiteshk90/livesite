    ...
    <>
      ...
      <div className="EMIBox w-11/12 md:w-4/5 lg:w-4/5 mx-auto my-10">
        ...
        <div className="resBox">
          ...
          <div className="px-5 py-5"><button class="bg-blue-gradient cursor-pointer text-white  items-center justify-center font-medium px-5 rounded-3xl p-2 mt-6 mb-4 w-full">Apply Now</button></div>
        </div>
      </div>
    </>
  );
