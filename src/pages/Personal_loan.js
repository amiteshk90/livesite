...
const Personal_loan = () => {
  ...
  return (
    <>
      <section className="flex pt-24 px-14 bg-personal personal_back">
        <div className="pt-12">
          <h1 className="text-black text-5xl font-normal">
            Get instant personal loans upto ₹5 lakhs
          </h1>
          <div className="flex text-xl font-medium pt-6 gap-5 items-center">
            <img src={money_personal} /> Multiple Lenders
          </div>
          <div className="flex text-xl font-medium gap-5 items-center pt-4">
        ...
        <div >
          <img src={personal_man} className="pb-16" style={{ zIndex: "-1", position: "relative" }} />
        </div>
      </section>

      <section className="flex bg-personal_bottom pb-12" style={{ backgroundPosition: "bottom center", backgroundSize: "cover", paddingBottom: "10rem" }}>
            ...
            <div className="flex justify-center items-center">
              ...
              <div className="m-5">
                ...
                <p className="text-white text-lg font-normal pt-4">
                  Get instant business loans approved in 24 <br /> hours, backed by a
                  network of diverse <br /> lending partners.
                </p>
              </div>
            </div>
            <div className="flex justify-center items-center">
      ...
      <section className="py-24 px-14">
        <div className="container mx-auto">
          <h1 className="text-custom-black text-4xl text-right font-semibold">What you can use personal loans for?</h1>
          <div className="flex gap-6 items-center justify-between my-14">
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={startup} className="mb-4" />
              <h3 className="text-2xl font-semibold">Start up a new business </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={newhome} className="mb-4" />
              <h3 className="text-2xl font-semibold">Buy a new Home </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={household} className="mb-4" />
              <h3 className="text-2xl font-semibold">Household<br />Utilities </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={common} className="mb-4" />
              <h3 className="text-2xl font-semibold">Common<br />
                Expense </h3>
            </div>
          </div>
          <div className="flex gap-6 items-center justify-between mt-14">
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={medical} className="mb-4" />
              <h3 className="text-2xl font-semibold">Medical<br />
                Emergency </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={wedding} className="mb-4" />
              <h3 className="text-2xl font-semibold">Wedding<br /> </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={vacation} className="mb-4" />
              <h3 className="text-2xl font-semibold">Unplanned<br />
                Vacation </h3>
            </div>
            <div className="bg-per_icon_bg p-4 flex-1 h-48">
              <img src={education} className="mb-4" />
              <h3 className="text-2xl font-semibold">Education<br />
                Purpose</h3>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-14 pb-40">
        <div className="container mx-auto">
          <h1 className="text-center text-5xl text-custom-black font-semibold">Our Blogs</h1>
          <div className="flex gap-10 mt-10">
            <div className="flex-1 bg-white">
              <img src={post_img_1} className="w-full mb-3" />
              <h3 className="text-2xl font-semibold mb-3 h-24 overflow-hidden">Tips for Effective Debt Management and Financial Freedom</h3>
              <p className="text-base font-normal text-custom-gray mb-3">Tips for Effective Debt Management and Financial Freedom. Savings Hacks for Short-Term and Long-Term Goals...<span className="text-blue-400">Read More</span></p>
              <div className="flex justify-between">
                <div className="flex justify-between items-center gap-2"><CiCalendar /> 15 Dec 2023</div>
                <div className="flex justify-between items-center gap-2"><FaRegCommentAlt /> 12 Comments</div>
              </div>
            </div>
            <div className="flex-1 bg-white">
              <img src={post_img_2} className="w-full mb-3" />
              <h3 className="text-2xl font-semibold mb-3 h-24 overflow-hidden">Savings Hacks for Short-Term and Long-Term Goals</h3>
              <p className="text-base font-normal text-custom-gray mb-3">Tips for Effective Debt Management and Financial Freedom. Savings Hacks for Short-Term and Long-Term Goals...<span className="text-blue-400">Read More</span></p>
              <div className="flex justify-between">
                <div className="flex justify-between items-center gap-2"><CiCalendar /> 15 Dec 2023</div>
                <div className="flex justify-between items-center gap-2"><FaRegCommentAlt /> 12 Comments</div>
            ...
            <div className="flex-1 bg-white">
              ...
              <h3 className="text-2xl font-semibold mb-3 h-24 overflow-hidden">The Importance of Emergency Funds in Uncertain Times</h3>
              <p className="text-base font-normal text-custom-gray mb-3">Tips for Effective Debt Management and Financial Freedom. Savings Hacks for Short-Term and Long-Term Goals...<span className="text-blue-400">Read More</span></p>
              <div className="flex justify-between">
                <div className="flex justify-between items-center gap-2"><CiCalendar /> 15 Dec 2023</div>
                <div className="flex justify-between items-center gap-2"><FaRegCommentAlt /> 12 Comments</div>
          ...
          <div className="mt-10 text-center mx-auto">
            <button class="text-indigo-800 mx-auto font-medium bg-white px-5 p-2" style={{ borderRadius: "100px", backgroundColor: "rgb(0, 87, 255)", color: "#fff" }}>Apply For Loan</button>
          </div>
        </div>
