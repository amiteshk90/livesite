    ...
    return (
        <section className="scoll-smooth try" style={{height: '100vh'}}>
            <div className="container ">
                ...
                <div className="flex flex-col items-center m-auto py-12 px-12 bg-scroll-bg rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" style={{marginTop: "31em", transform: "scale(1.2)",}}>
