...
const PrivacyPolicy = () => {
  return (
    <div className="bg-gray-100 p-8 sm:p-16 md:p-24 lg:p-32">
      <div className="max-w-4xl mx-auto bg-white p-6 sm:p-10 md:p-14 lg:p-20 rounded-lg shadow-md">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          Privacy Policy
        </h1>

        <p className="text-gray-700 mb-4">
          We, at Sumami Technologies private limited (“Lendingking Brand of "
          Sumami Technologies private limited"” or “We”) understand Privacy and
          its value. Therefore, it is all the more important for us to make YOU
          (“You” or “Customer” or “User”), the User of the website{" "}
          <a
            className="underline text-blue-600 text-xl"
            href="https://www.lendingking.in/"
          >
            www.Lendingking.in
          </a>{" "}
          and mobile android application Brand of"Sumami Technologies private
          limited".in (the “Website”) and its associated mobile applications,
          Lendingking Brand of"Sumami Technologies private limited"
          (“Application”) (collectively, the “Platform”) understand the reason
          behind collection of your information and its usage and the manner in
          which we collect, use, store and share information about you (“Privacy
          Policy”). This Privacy Policy has been prepared in compliance with:
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          non-lending services by partnering with various financial lenders,
          third parties, service providers, etc based on your requirement to
          avail such Services (“Services”).
        </p>
        <p className="text-gray-700 mb-4">
          The Company shall tie up with authorized RBI lenders to ensure you get
          the best financing options. We have currently ties up with the
          following financing partners (i.e. Lenders) – Lendingkart Finance
          Limited , Mirae asset financial services , Arthmate Financing India
          Private Limited.
        </p>
        <p className="text-gray-700 mb-4">
          Lendingking Brand of"Sumami Technologies private limited" will only be
          using the information for providing the Services to you. In order to
          avail any Services being provided by Lendingking Brand of"Sumami
          Technologies private limited" by itself or in partnership with the
          lenders or other third parties it is important that YOU READ,
          UNDERSTAND, ACKNOWLEDGE AND UNCONDITIONALLY AGREE TO BE BOUND BY THE
          TERMS AND CONDITIONS OF THIS PRIVACY POLICY. IF YOU DO NOT AGREE TO
          THIS POLICY OR ANY PART THEREOF, PLEASE DO NOT USE/ ACCESS/ DOWNLOAD/
          INSTALL THE PLATFORM OR ANY PART THEREOF. For the users consenting to
          continue accessing the Platform and avail the Services, this Privacy
          Policy explains our policies and practices regarding the collection,
        ...
        <p className="text-gray-700 mb-4">
          Information collected by Platform for facilitation of Loans being
          disbursed by the financial lending partners whose details are
          available on the Website and the Application and who are registered
          with the Reserve Bank of India (“Lending Partners”).
        </p>
        <h3 className="text-lg font-semibold mb-2">
          Part B: Information for Non-Lending Services
        </h3>
        <p className="text-gray-700 mb-4">
          Information collected by Platform while registering a User on the
          Platform or while providing Value Added Services (i.e. all services
        ...
        <p className="text-gray-700 mb-4">
          ...
          Lendingking Brand of"Sumami Technologies private limited" will be
          required to access, collect and share Personal Information with its
          lending partners that may be banks or NBFCs registered with the
          Reserve Bank of India or any other third-party providing value added
          services in partnership with Lendingking Brand of"Sumami Technologies
          private limited". In such cases, Lendingking Brand of"Sumami
          Technologies private limited" will share the information securely and
          ensure that all personal information recipients comply with
          confidentiality, fidelity and secrecy obligations and sign covenants
          in this regard.Lendingking Brand of"Sumami Technologies private
          limited" may make information available to third parties that are
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          <li>
            ...
            name, email id, PAN, GST Network user id & password, address, mobile
            number, postal code.
          </li>
          <li>
            Social Account Information: Lendingking Brand of"Sumami Technologies
            private limited" may provide you with the option to register using
            social accounts (Google or Facebook) to access the app and shall
            collect only such registered email id and user public profile
          ...
          <li>
            SMS Information: Lendingking Brand of"Sumami Technologies private
            limited" collects, stores and monitors SMS information from your
            device. However, we do not store or monitor your Personal SMS
            information.
          </li>
          <li>
            ...
            including such purposes as may be required by the Lending Partners
            or as per applicable law. This category of information is only
            collected for providing the non-lending services or our value-added
            services
          </li>
          ...
          <li>
            ...
            non-lending services.nformation which the Application collects, and
            its usage, depends on how you manage your privacy controls on your
            device.
          </li>
          <ul className="list-disc list-inside mb-4 text-gray-700">
            <li>
              (i) Device Information: When you install the Application, we store
              the information we collect with unique identifiers tied to the
              device you are using. We collect information from the device when
              you download and install the Application and explicitly seek
              permissions from You to get the required information from the
              device. Additionally, we also collect your Log information (via
              the domain server through which the User accesses the App Search
              ...
              collect information about your device to provide automatic updates
              and additional security so that your account is not used in other
              people’s devices. In addition, the information provides us
              valuable feedback on your identity as a device holder as well as
              your device behaviour, thereby allowing us to improve our products
              interaction, quality of services and provide an enhanced
              customized user experience to you. We further collect other
              identifiable information such as your transactions history on the
              Platform when you set up a free account with us.
            </li>
            <li>
              (ii) Installed Application Data: We collect and transmit a list of
          ...
          <li>
            ...
            lending services as well as providing any non-lending services only
            in accordance with applicable laws.
          </li>
          <li>
            How we use this information: We shall collect your device location
            information for verifying your address, for the KYC and onboarding
            process for the Services. We may request camera access to scan and
            capture the required KYC documents as per the instructions of our
            Lending Partners in accordance with applicable laws. We shall
            transfer such information to our Lending Partners and shall not
            store any such data. We require microphone permissions to enable a
            two-way communication between our authorised agents and you for the
            purpose of performing and completing your Video KYC for the Lending
            Services. Your audio shall be recorded for regulatory purpose.
          </li>
        </ul>
        ...
        <p className="text-gray-700 mb-4">
          ...
          bureaus or credit rating companies as your ‘authorised representative’
          from time to time in accordance with applicable laws during the loan
          journey as may be requested by our Lending Partners.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          <li>
            Data provided by you by filling in forms in the Application or on
            the Website.
          </li>
          <li>
            Data provided by corresponding with us (for example, by e-mail or
            chat).
          </li>
          <li>
            Data and information, you provide when you register to use the
            Website, download or register on our App, subscribe to any of our
            Services (such as applying for a loan), search for a Service, and
            when you report a problem with our App, our Services, or any of our
            Sites.
          </li>
          <li>
            Data including your name, address, gender, date of birth, e-mail
            address, phone number, username, password and other registration
            information.
          </li>
          <li>
            PAN Card, Aadhaar Card, financial information such as employer name,
            monthly salary, bank account no., bank statements, credit
            information, GST information, copies of identification documents
            which are forwarded to our Lending Partners for the onboarding of
            your application to avail the services.
          </li>
          <li>Data generated by your usage of our Platform.</li>
          <li>
            Contact details (i.e. the phone number)of the third party
            individuals (including your relatives and friends) that are
            voluntarily added by you at the time of loan application.
          </li>
        </ul>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          ...
          We will use cookies on our Website similar to other lending websites /
          apps and online marketplace websites / apps. Use of this information
          helps Us identify You in order to make our Website more user friendly.
          Most browsers will permit You to decline cookies but if You choose to
          do this it might affect service on some parts of Our Website.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          ...
          <li>
            use the User information in other ways permitted by law to enable
            You to take financial services from our lending partners.
          </li>
          <li>
        ...
        <p className="text-gray-700 mb-4">
          ...
          Services on the Platform. We will share the information only in such
          manner as described below:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>
            We disclose and share Your information with the financial service
            providers, banks or NBFCs and our Lending Partners for facilitation
          ...
          <li>
            We will disclose the data / information provided by a user with
            other technology partners to track how the user interacts with the
          ...
          <li>
            ...
            restructuring of business for continuity of business. Should such a
            transaction occur than any business entity (or the new combined
            entity) receiving any such information from us shall be bound by
            this Policy with respect to your information.
          </li>
          <li>
          ...
          <li>
            We will share Your information under a confidentiality agreement
            ...
            there will be no unauthorized disclosure of your information shared
            with third parties.
          </li>
          <li>
            We shall disclose your KYC journey or any data with respect to the
            same to the relevant regulatory authorities as a part of our
            statutory audit process. Please note that your Aadhaar number shall
            never be disclosed.
          </li>
          <li>
            We may share your personal information with the governmental
            authorities, quasi-governmental authorities, judicial authorities
            and quasi-judicial authorities if we are acting under any duty,
            request or order as part of our legal obligations and in accordance
            with the applicable laws. By accepting this Privacy Policy, you
            hereby provide your consent to disclose your personal information
          ...
          <li>
            ...
            <ul className="list-decimal pl-6 mt-2">
              <li>
                ...
                shall reasonably endeavor to notify the same to you accordingly
                as the case may be as stated under subclause 3;
              </li>
              <li>
              ...
              <li>
                We shall share your information with third-party only on a need
                basis and only for the purpose stated hereunder, as per the
                applicable laws.
              </li>
              <li>
                We shall additionally seek express consent through a separate
                consent at appropriate stages of data collection, if so required
          ...
          <li>
            ...
            privacy policies. We share limited information with them, strictly
            to the extent required. We recommend you to have a look at the
          ...
          <li>
            ...
            >
              https://www.Lendingking.in
            </a>{" "}
            Brand of' Sumami Technologies private
            limited'.in/our-lending-partners - Lendingkart finance limited ,
        ...
        <p className="text-gray-700 mb-4">
          We at Lendingking Brand of "Sumami Technologies private limited"
          promise to protect your personal data from unauthorized access,
        ...
        <p className="text-gray-700 mb-4">
          ...
          services. We may also retain and use your basic personal information
          inter alia as name, contact number, transactional details, and address
          details as necessary to comply with our legal obligations, resolve
          disputes, and enforce our agreements which shall always be in
          accordance with applicable laws.
        </p>
        <p className="text-gray-700 mb-4">
          Subject to this section, we may delete your data upon reasonable
          written request for the same at any stage. However, you may not be
          able to access or use our service after deletion.
        </p>
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          ...
          laws. Our third-party service provider employs separation of
          environments and segregation of duties and have strict role-based
          ...
          integrity monitoring, and application control solutions. We don't
          allow unauthorized access to your non-public personal contacts or
          financial transaction SMS data with any third party in relation to
          Lending Services other than our Lending Partners. However, for
          Non-Lending Services (Value Added Services i. e. Expense Tracker), we
          may allow third parties to access your financial transaction SMS
          subject to your explicit consent. Our Platform links to other websites
          that may collect information about you. We are not responsible for the
          privacy practices or the content of those linked websites. With this
          Policy we’re only addressing the disclosure and use of data collected
          by Us. Their data collection practices, and their policies might be
        ...
        <p className="text-gray-700 mb-4">
          ...
          information from unauthorized access, use and disclosure. Our Platform
          has stringent security measures in place to protect the loss, misuse
          and alteration of information under control. We endeavour to safeguard
          ...
          the information, which is currently the required level of encryption
          in India as per applicable law. We blend security at multiple steps
          within our products with the state-of-the-art technology to ensure our
          systems maintain strong security measures and the overall data and
          privacy security design allow us to defend our systems ranging from
          low hanging issue up to sophisticated attacks. In addition,
        </p>

        <p className="text-gray-700 mb-4">
          the Website and App have been certified for the following security
          certifications:
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          ...
          thereunder. When we receive formal written complaints, we respond by
        ...
        <p className="text-gray-700 mb-4">
          ...
          verification by the Company. Your Privacy Controls: You have certain
          choices regarding the information we collect and how it is used:
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">Delete the App from your device</p>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          You acknowledge that the Platform has duly collected the information
          with your consent and you have the option to not provide such
          information, or deny consent for use of specific information or revoke
          the consent already given. However, any withdrawal of such personal
          information will not be permitted in case any Service availed by You
          is active. Where a consent has been withdrawn the Platform does not
          guarantee or be liable for providing such Service. You shall have the
        ...
        <p className="text-gray-700 mb-4">
          You shall have the right to deny consent for use of specific data,
          restrict disclosure to third parties, data retention, revoke consent
          already granted to collect personal data and if required, make the App
          delete/ forget the data. However, any such denial will not prejudice
          the right of the Lending Partners to retain any data in relation to
          the loans availed by you or by the non-lending service providers in
          relation to the non-lending services provided to you. Further, in case
          of a denial of a consent, the Platform does not provide a guarantee or
          will not be liable towards the continued facilitation of the Services
        ...
        <p className="text-gray-700 mb-4">
          ...
          collection, use or disclosure of Your information, at any time, or
          request for deletion of your Login account by raising a request on the
          Platform or by mailing Us at help@Lendingking Brand of"Sumami
          Technologies private limited".in. However, Platform does not provide a
          guarantee of Services if any such controls are exercised. Further, if
          You have availed any loan facilities from Our lending partner, the
          lending partner shall have the right to continue processing Your
          information till such credit facility has been repaid in full, along
          with any interest and dues payable and/or for such period as may be
          allowed under applicable law. However, We, shall not retain Your data
          and information if it is no longer required by Us and there is no
          legal requirement to retain the same. Do note that multiple legal
          bases may exist in parallel, and We may still have to retain certain
          data and information at any time. Also, the information may still be
          used for execution of any outstanding or termination activity of any
          Lending or Non-lending Services
        </p>
        ...
        <p className="text-gray-700 mb-4">
          You have a right to report a security incident to the GRO (detailed
          mentioned hereinbelow). You are entitled shall be entitled to prevent
          unauthorised such usage of your information by our personnel/agents by
          informing us, within 10 days of being informed of the proposed use,
          that you do not wish to disclose such information.
        </p>
        <p className="text-gray-700 mb-4">
          You can also exercise the right at any time by contacting us at
          help@Lendingking Brand of"Sumami Technologies private limited".in
        ...
        <p className="text-gray-700 mb-4">
          The consent for this information can be withdrawn if You write an
          email to the email address provided under clause VIII.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          Minimum 6 months and the maximum period for repayment is up to 60
          months based on the type of loans. Minimum 10.50% up to 26% Maximum
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          <li>Loan Amount - 1,00,000 INR</li>
          <li>Rate of Interest - 20%</li>
          <li>Tenure - 6 months</li>
          <li>Total EMI - 17,652 INR per month</li>
          <li>Total Amount Payable - 1,05,914 INR</li>
          <li>Total Interest - 5,914 INR</li>
          <li>Processing fee - 2-5% of the loan amount</li>
        </ul>
      </div>
    </div>
  );
